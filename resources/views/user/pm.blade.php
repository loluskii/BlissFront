                        ...
                        <div class="col-8">
                            <div class="row row-1 justify-content-between align-items-center justify-content-center">
                                @if ($defaultPaymentMethod->card->brand == 'mastercard')
                                    <img class="img-fluid" src="{{ asset('images/mc_vrt_pos.svg') }}" style="height: 60px" />
                                @else
                                    <i class="fab fa-cc-visa fa-3x" aria-hidden="true"></i>
                                @endif
                                <div class="col">
                                    <p class="mb-0 font-weight-bold">{{ $defaultPaymentMethod->billing_details->name }}</p>
                                    <small class="mb-0">**** {{ $defaultPaymentMethod->card->last4 }} | {{ $defaultPaymentMethod->card->exp_month }}/{{ $defaultPaymentMethod->card->exp_year }}</small>
                                </div>
                    ...
                    <div class="col-8 pl-0 pt-3 pb-5">
                        ...
                        <div class="row row-1 justify-content-between align-items-center justify-content-center">
                            ...
                            <div class="col">
                                ...
                                <small class="mb-0">**** {{ $item->card->last4 }} | {{ $item->card->exp_month }}/{{ $item->card->exp_year }}</small>
                            </div>
