                ...
                <div class="card-body py-2 pr-1">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="font-weight-bold mb-0 text-uppercase text-gray-800">{{ $user->fname  }} {{ $user->lname  }}</div>
                            <div class="text-gray-800" style="font-size: small"><span class="font-weight-bold">Email:</span> {{ $user->email  }}</div>
                            <div class="text-gray-800" style="font-size: small"><span class="font-weight-bold">Phone No:</span> {{ $user->phone_number  }}</div>
                        </div>
                        {{-- <div class="col-auto">
