                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-sm"
                                        href="{{ route('admin.stores.view', $store->id) }}" role="button">View</a>
                                    <a data-toggle="modal" data-target="#newStore{{ $store->id }}"
                                        class="btn btn-info btn-sm" href="#" role="button">Edit</a>
                                    <div class="modal fade" id="newStore{{ $store->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.store.update', $store->id) }}"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="city" class="form-control"
                                                                value="{{ $store->city }}" aria-describedby="helpId">
                                                        </div>
                                                        <div class="form-group">
